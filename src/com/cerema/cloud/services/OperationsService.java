...
package com.cerema.cloud2.services;
...
import com.cerema.cloud2.lib.common.OwnCloudCredentialsFactory;
import com.cerema.cloud2.lib.common.accounts.AccountUtils.AccountNotFoundException;
...
import com.cerema.cloud2.lib.resources.users.GetRemoteUserNameOperation;
...
import com.cerema.cloud2.operations.GetServerInfoOperation;
import com.cerema.cloud2.operations.MoveFileOperation;
import com.cerema.cloud2.operations.OAuth2GetAccessToken;
...
import com.cerema.cloud2.operations.common.SyncOperation;
                ...
                try {
                    ...
                    if (mLastTarget == null || !mLastTarget.equals(next.first)) {
                        ...
                        if (mLastTarget.mAccount != null) {
                            ...
                            OwnCloudVersion version = com.cerema.cloud2.authentication.AccountUtils.getServerVersion(
